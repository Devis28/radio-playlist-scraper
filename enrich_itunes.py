# enrich_itunes.py
# Obohatí položky v data/playlist.json o:
# {year, duration_ms, duration, genre, album, track_number, disc_number}
# cez iTunes Search API. Ak sa údaj nenájde, zapíše "Not found".
